        ...
        ?> 
          ...
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="text" name="from" id="txtSource" class="form-control" placeholder="From"  required/>
               </div>
          </div>
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   <i class="glyphicon glyphicon-map-marker"></i>
                   <input type="text" name="to" id="txtDestination" class="form-control" placeholder="To" required/>
               </div>
          </div>
          <div class="col-md-4">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="text" name="from_date" id="from_date" class="form-control" placeholder="From Date" value="<?php echo date('m-d-Y')?>" required/>
               </div>
          </div>
          <div class="col-md-4">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="text" name="pick_up_time" id="pick_up_time" class="form-control" placeholder="Time" value="9 : 00 AM" required/>
               </div>
          </div>
          <div class="col-md-4">
               ...
               <div class="inner-addon left-addon">
                   <i class="glyphicon glyphicon-calendar"></i>
                   <input type="text" name="to_date" id="to_date" class="form-control" placeholder="To Date" value="<?php echo date('m-d-Y')?>" required/>
               </div>
          </div>
          ...
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="number" name="p_number" id="p_number" class="form-control" placeholder="Personal Number"/>
               </div>
          </div>
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   <i class="glyphicon glyphicon-phone-alt"></i>
                   <input type="number" name="o_number" id="o_number" class="form-control" placeholder="Official Number"/>
               </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="number" name="no_of_buses" id="no_of_buses" class="form-control" value="1" readonly="readonly" required="required"/>
               </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   <i class="glyphicon glyphicon-time"></i>
                   <input type="text" name="drive" id="drive" class="form-control" placeholder="Drive" readonly required="required"/>
               </div>
          </div>
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="text" name="distance" id="distance" class="form-control" placeholder="Distance" readonly required="required"/>
               </div>
          </div>
          <div class="col-md-6">
               ...
               <div class="inner-addon left-addon">
                   ...
                   <input type="text" name="cost" id="cost" class="form-control" placeholder="Estimated Trip Cost" readonly required="required"/>
               </div>
          ...
          <div class="col-md-12">
               <div class="form-group">
                  ...
                  <input type="button" value="Estimate" class="btn btn-primary orange-btn pull-right" onclick="GetRoute()" />  
               </div>
          </div>
       <?php echo form_close();?>
    </div>
