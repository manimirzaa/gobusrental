...
<img src="<?php echo $this->config->base_url();?>images/general/cost_calculator.jpg" alt="Distance calculator" height="250" width="100%">
        ...
        <div class="row">
                 ...
                 <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active fade in" id="one_way">
                          ...
                          <?php include(APPPATH.'/views/front/cost_calculator_tabs/one_way.php'); ?>
              
                      </div>
                      <div role="tabpanel" class="tab-pane fade in" id="round_trip">
                           
                           <?php include(APPPATH.'/views/front/cost_calculator_tabs/round_trip.php'); ?>
              
                      </div>
                      <div role="tabpanel" class="tab-pane fade in" id="multi_days">
              
                           <?php include(APPPATH.'/views/front/cost_calculator_tabs/multi_days_same_city.php'); ?>
                            
                      </div>
                      <div role="tabpanel" class="tab-pane fade in" id="multi_cities">
              
                           <?php include(APPPATH.'/views/front/cost_calculator_tabs/multi_cities.php'); ?>
