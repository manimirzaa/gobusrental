...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>GO BUS RENTALS LOGIN</title>
		<!-- start: META -->
		<meta charset="utf-8" />
	...
	<body class="login example1">
		<div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
			<div class="logo"><a href="<?php echo base_url();?>">GO BUS RENTALS</a>
			</div>
			<!-- start: LOGIN BOX -->
			<div class="box-login">
                ...
                <?php
				$attributes = array('name' => 'login', 'class'=>'form-login');
				...
				?>
					...
					<fieldset>
						...
						<div class="form-actions">
							<?php /*?><label for="remember" class="checkbox-inline">
			...
			<div class="box-forgot">
                ...
                <?php
				$attributes = array('name' => 'forget_password');
			...
			<!-- start: COPYRIGHT -->
			<div class="copyright">
				<?php echo date('Y');?> &copy; GO BUS RENTALS
			</div>
			<!-- end: COPYRIGHT -->
		</div>
		...
		<script src="<?php echo base_url('design/admin') ?>/js/login.js"></script>
